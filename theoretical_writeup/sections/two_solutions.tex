...
The question that concerns the production team is "What is in the generator right now and how much product can I get out of it?". Quest to answering this question can lead us down two surprisingly divergent paths.
...
\begin{equation}
	Q_{n}(t) = Q_n(0)\cdot\prod_{j=1}^{n-1}k_{j,j+1}\cdot\sum_{j=1}^{n}\frac{e^{-k_{j}t}}{\displaystyle\prod_{\substack{p=1 \\ p\ne j}}^{n}(k_{p}-k_{j})}
