...
\title[Relationship between Bateman and matrices]{Multi-isotope generator calculation}
...
\abstract{A brief explanation of the math behind solving arbitrarily complex isotope generator.}

\maketitle

\input{sections/introduction}
\input{sections/two_solutions}
